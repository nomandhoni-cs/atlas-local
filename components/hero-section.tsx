    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-100 font-['Urbanist',sans-serif]">
      ...
      <main className="container mx-auto px-6 py-16">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-6xl md:text-7xl font-sans font-extrabold text-gray-900 mb-8 leading-tight">
          ...
          <p className="text-2xl font-sans text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed font-medium">
            Analyze environmental data, calculate solar savings, assess
            rainwater collection potential, and make informed decisions about
            your property's sustainable future with comprehensive carbon impact
            analysis.
          </p>
          ...
          <Button
            ...
            size="lg"
            className="bg-green-600 font-sans hover:bg-green-700 text-white px-12 py-6 text-xl font-bold rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1"
          >
          ...
          <div className="mt-8 text-gray-600 text-lg">
            <p>
              ✨ Free analysis • 🌍 Real environmental data • 💡 Actionable
              insights
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20 max-w-6xl mx-auto">
          <Card className="group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 bg-white/90 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Calculate potential solar energy generation, monthly savings,
                and electricity production for any location or roof area with
          ...
          <Card className="group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 bg-white/90 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Estimate rainwater collection potential in gallons, cost
                savings, and environmental impact based on roof area and local
                precipitation data.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 bg-white/90 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Get comprehensive environmental analysis including air quality,
                carbon emissions reduction, and sustainability metrics with
                actionable insights.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-12 max-w-4xl mx-auto">
          <Card className="group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 bg-white/90 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Detailed cost-benefit analysis with ROI calculations, payback
                periods, and long-term financial projections for sustainable
                investments.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 bg-white/90 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Comprehensive energy analysis including consumption patterns,
                efficiency recommendations, and potential energy independence
                calculations.
              </p>
            </CardContent>
          </Card>
        ...
        <Card className="mt-20 border-0 bg-white/90 backdrop-blur-sm shadow-2xl">
          <CardContent className="text-center p-12">
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
              Join thousands of property owners making data-driven decisions for
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center text-lg">
              <div className="flex items-center text-gray-600 bg-green-50 px-6 py-3 rounded-full border border-green-200">
                ...
                <span className="font-medium">
                  Click properties or explore anywhere
                </span>
              </div>
              <div className="flex items-center text-gray-600 bg-green-50 px-6 py-3 rounded-full border border-green-200">
                <Sun className="h-5 w-5 mr-2 text-green-600" />
                <span className="font-medium">
                  Draw polygons for roof analysis
                </span>
              </div>
              <div className="flex items-center text-gray-600 bg-green-50 px-6 py-3 rounded-full border border-green-200">
